...
[ExcludeClass]
public class _Client_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _Client_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "kuraraysaijo.view.Client" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "SharedResources", "collections", "components", "containers", "controls", "core", "effects", "layout", "logging", "skins", "sparkEffects", "styles", "textLayout" ],
            currentDomain: ApplicationDomain.currentDomain,
            fonts:       {
"Noto Sans Mono CJK JP Bold" : {regular:true, bold:false, italic:false, boldItalic:false}
,
"Noto Sans Mono CJK JP Bold CFF" : {regular:true, bold:false, italic:false, boldItalic:false}
,
"Noto Sans Mono CJK JP Regular" : {regular:true, bold:false, italic:false, boldItalic:false}
,
"Noto Sans Mono CJK JP Regular CFF" : {regular:true, bold:false, italic:false, boldItalic:false}
}
,
            mainClassName: "kuraraysaijo.view.Client",
            mixins: [ "_Client_FlexInit", "_Client_Styles", "mx.styles.StyleManagerImpl", "mx.managers.systemClasses.ActiveWindowManager", "mx.messaging.config.LoaderConfig" ],
