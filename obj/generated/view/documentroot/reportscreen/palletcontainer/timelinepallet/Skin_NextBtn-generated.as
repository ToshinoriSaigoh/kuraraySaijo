 ...
 *  Class:      Skin_NextBtn
 *  Source:     F:\git\KuraraySaijo\src\view\documentroot\reportscreen\palletcontainer\timelinepallet\Skin_NextBtn.mxml
 ...
 **/
    ...
    public function Skin_NextBtn()
    {
        ...
        // properties
        this.mxmlContent = [_Skin_NextBtn_Rect1_i(), _Skin_NextBtn_Group1_i(), _Skin_NextBtn_Rect2_i()];
        this.currentState = "up";


        // events
        this.addEventListener("creationComplete", ___Skin_NextBtn_Skin_BtnRect1_creationComplete);
    ...
    //  <Script>, line 9 - 16
		...
		{
			[Embed(source = "icon_timelinepallet_next.svg", mimeType="application/octet-stream")]
			var Svg: Class;
			setSvg(Svg, "icon");
		}
...
private function _Skin_NextBtn_Rect1_i() : spark.primitives.Rect
{
	...
	temp.bottom = 0;
	temp.alpha = 1.0;
	temp.fill = _Skin_NextBtn_SolidColor1_c();
...
private function _Skin_NextBtn_SolidColor1_c() : mx.graphics.SolidColor
{
...
private function _Skin_NextBtn_Rect2_i() : spark.primitives.Rect
{
	var temp : spark.primitives.Rect = new spark.primitives.Rect();
	temp.left = 0;
	temp.right = 0;
 ...
 * @private
 **/
public function ___Skin_NextBtn_Skin_BtnRect1_creationComplete(event:mx.events.FlexEvent):void
{
	_init()
}
