...
public class ja_JP$controls_properties extends ResourceBundle
{
    ...
    override protected function getContent():Object
    {
        var content:Object =
        {
            ...
            "unexpectedEnd": "予期しない cuePoint パラメーター文字列の終わりです",
            ...
            "missingRoot": "URL: '{0}' ルートノードが見つかりませんでした。URL が FLV に対するものである場合は、拡張子を .flv にし、パラメーターを指定しないでください。",
            ...
            "label": "ロード中 %3%%",
            "wrongFormat": "予期しない cuePoint パラメーターの形式です",
